...
public class Cat extends Animal {
    ...
    public void klubok() {
        System.out.println(" кот " + name + ", с возрастом-" + age + " , c цветом шерсти: " + color + " -- свернулся в клубок");
    }
    ...
    public void animalInfo() {
        System.out.println("Это кот с именем " + name + ", с возрастом-" + age + " , c цветом шерсти: " + color);
    }
